...
namespace WebUygulamaProje1.Controllers
{
    ...
    public class KitapController : Controller
    {
        ...
        public IActionResult Index()
        {
			...
			List<Kitap> objKitapList = _kitapRepository.GetAll(inculedeProps:"KitapTuru").ToList();
        ...
        public IActionResult EkleGuncelle(Kitap kitap, IFormFile? file)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                string kitapPath = Path.Combine(wwwwRootPath, @"img");
                ...
                if(kitap.Id== 0) 
                {
					...
					TempData["basarili"] = "Yeni Kitap Başarılı Bir Şekilde Oluşturuldu!";
				}
                else
                {
                ...
                _kitapRepository.Kaydet();   //save changes yapılmazsa bilgiler veri tabanına eklenmez
